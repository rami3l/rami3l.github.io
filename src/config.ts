...
export const SITE = "https://rami3l.github.io";
...
export const SITE_TITLE = "rami's scratchpad";

// will be used in the meta tags (and for example shown in search results)
export const SITE_DESCRIPTION = "A place for my wandering thoughts 🍵";
...
export const MANUAL_DARK_MODE = false;
